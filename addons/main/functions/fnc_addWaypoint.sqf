...
["SAA_addWaypointServer",[_WP,_behaviour,_combatMode,_speed,_formation]] call CBA_fnc_serverEvent;

[{
	params ["_WP","_position"];
	_WP setWaypointPosition [_position,0];
},[_WP,_position],1] call CBA_fnc_waitAndExecute;
