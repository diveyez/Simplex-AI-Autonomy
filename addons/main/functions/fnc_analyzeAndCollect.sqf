...
if (_group getVariable "SAA_available") then {
	...
	([units _group,true] call FUNC(getTypes)) params ["_infantry","_tanks","_cars","_helis","_groupAT"];
...
([_nearestUnits,true] call FUNC(getTypes)) params ["_nearestInfantry","_nearestTanks","_nearestCars","_nearestHelis","_nearestAT"];
