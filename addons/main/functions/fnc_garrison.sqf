		...
		[{
			...
			[_leader,"FiredNear",{
				...
				[{
					...
					[_group,(_group getVariable "SAA_origin") # 0,15,"SAD","AWARE","RED","NORMAL","WEDGE",["true",""],[0,0,0],15] call FUNC(addWaypoint);
					[{
						_this call FUNC(clearWaypoints);
						["SAA_returnToOrigin",_this,_this] call CBA_fnc_targetEvent;
