...
_ctrl ctrlSetPosition [0,_posY,BUTTON2_WIDTH,BUTTON_HEIGHT];
_ctrl ctrlCommit 0;
_ctrl ctrlSetText _descriptionText1;
_ctrl ctrlSetTooltip _descriptionTooltip1;

private _ctrl2 = _display ctrlCreate [QGVAR(Button),-1,_ctrlGroup];
_ctrl2 ctrlSetPosition [BUTTON2_WIDTH + (SPACING_W / 2),_posY,BUTTON2_WIDTH,BUTTON_HEIGHT];
_ctrl2 ctrlCommit 0;
